...
if(isset($_POST["limit"], $_POST["start"])){ 
    $sql = "SELECT * FROM medias WHERE user_id IN (SELECT receiver_id FROM followzone WHERE sender_id='$myidd') AND status='published' AND NOT user_id='$myidd' ORDER BY id DESC LIMIT ".$_POST["start"].", ".$_POST["limit"]."";
