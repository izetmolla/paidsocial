<?php 
    require_once($_SERVER['DOCUMENT_ROOT'] . "/includes/themes/construct/profile/functions.php"); ?>
<html lang="en"><head>
  <base href="/">
      ...
      <div id="app">
          ...
          <main>
              <div class="_145UW">
                  <div class="_1zU3Y">
                      <div class="_2CL8h">
                          <div class="o4egS">
                              ...
                              <div class="_2Fc3c">
                                  <div class="_2HRoL">
                                        <p class="_3-h_O textcenter" style="padding:2px"><?php echo $user['username']; ?></p> 
                                  </div>
                                  <div class="_2HRoL">
                                      <div class="_3M-s6">
                                          <div class="_2RUgu">
                                  ...
                                  <?php 
                                        if($user['subscribe'] == 0){
                                            echo '<button class="_3udml" type="primary">No Subscribtion</button>';
                                        }else{
                                            echo '<button class="_3udml" type="primary">Subscribe ($'.$user['subscribe'].'/mo) Get Info</button>';
                                        }
                                  ?>
                              </div>
                          </div>
                  ...
                  <div class="xeZnn">
                      <a href="/#"><p><?php echo $cc = getProfileCount($user['username']); ?></p><p>posts</p></a>
                      <a href="#"><p><?php getProfileFollowersCount($user['id']); ?></p><p>followers</p></a>
                      <a href="#"><p><?php getProfileFollowingCount($user['id']); ?></p><p>following</p></a>
                      <a href="#"><p>0</p><p>subscriptions</p></a>
                  </div>
...
$(document).ready(function(){
 ...
 function load_country_data(limit, start){
  $.ajax({
   url:"/includes/themes/construct/profile/data/datamodel.php?username=<?php echo $_GET['username']; ?>",
   method:"POST",
